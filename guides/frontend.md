...
**Verify after deploy:** DevTools Network tab: `/ingest/` requests return **200**. PostHog Live shows `environment: production`. If `401` persists: confirm `VITE_PUBLIC_POSTHOG_PROJECT_TOKEN` in GitHub matches the active PostHog project.
