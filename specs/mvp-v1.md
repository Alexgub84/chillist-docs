...
| PostHog analytics (FE)    | Done        | `posthog-js` + `@posthog/react` in `main.tsx`. Autocapture on. `identify(userId)` on login, `reset()` on logout. Disabled locally when token is placeholder.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
