...
|---------|--------|-------|
| Plans CRUD | Done | Full REST API + FE screens. Delete plan UI with owner-only visibility + confirmation modal (issue #29). Admin delete button on plans list with confirmation modal (issue #103). |
